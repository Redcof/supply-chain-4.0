...
from tools.plots import plots, save
...
class BaseModel(ABC):
    ...
    def log_evaluation(model_name, dataset_name, phase, y, y_pred, x_timeseries, meta_info=""):
        ...
        name = "%s_%s_%s%s" % (dataset_name, model_name, phase, meta_info)
        plots(name, y, y_pred, x_timeseries)
        save(name, y, y_pred, x_timeseries)
